...
const decoratedHeader = figlet.textSync(package.name, {
...
var argv = require('yargs/yargs')(process.argv.slice(2))
  ...
  .options({
    ...
    config: {
      alias: 'c',
      description:
        'Specify all of the SSG options in a JSON formatted configuration file',
      type: 'string',
      requiresArg: true,
    },
  })
